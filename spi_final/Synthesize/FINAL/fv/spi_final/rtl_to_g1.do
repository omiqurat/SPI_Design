...
usage -auto
set log file fv/spi_final/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/spi_final/rtl_to_g1.ovf
...
write hier_compare dofile fv/spi_final/hier_rtl_to_g1.do \
...
run hier_compare fv/spi_final/hier_rtl_to_g1.do
usage
