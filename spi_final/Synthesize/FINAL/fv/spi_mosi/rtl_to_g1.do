...
usage -auto
set log file fv/spi_mosi/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/spi_mosi/rtl_to_g1.ovf
...
elaborate design -golden -root spi_mosi

read design -verilog -revised -lastmod -noelab \
	-unzip fv/spi_mosi/g1.v.gz

elaborate design -revised -root spi_mosi
