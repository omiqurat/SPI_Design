...
# clk_div (spi_clk, m_clk, spi_cs, nrst);

dc::set_ideal_net m_clk
dc::set_ideal_net nrst
...
write_sdf -nonegchecks > clk_div_sdf.sdf

# rc -f clk_div_rtlscript.g 
