...
define_clock -name Mclk -period 50000 [list "Mclk"]
external_delay -clock Mclk -input 0  /designs/*/ports_in/*
external_delay -clock Mclk -output 2 /designs/*/ports_out/*
...
# finalspi (Data_out,spi_clk,spi_cs,spi_mosi,Mclk,nReset,Data_available,Read_request,spi_miso,Data_in);

dc::set_load 0.2 [all_outputs]
dc::set_ideal_net Mclk
dc::set_ideal_net nReset
dc::set_ideal_net Data_available
dc::set_ideal_net Read_request
dc::set_ideal_net spi_miso


dc::set_ideal_net Data_in[7]
dc::set_ideal_net Data_in[6]
dc::set_ideal_net Data_in[5]
dc::set_ideal_net Data_in[4]
dc::set_ideal_net Data_in[3]
dc::set_ideal_net Data_in[2]
dc::set_ideal_net Data_in[1]
dc::set_ideal_net Data_in[0]
...
write_sdf -nonegchecks > final_sdf.sdf

# rc -f final_rtlscript.g 
