...
#  Created by Encounter(R) RTL Compiler v11.20-s017_1 on Mon Jul 18 16:12:57 +0200 2016
...
current_design asy_fifo_input

create_clock -name "clk" -add -period 50.0 -waveform {0.0 25.0} [get_ports clk]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports control_clk]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports data_av]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[4]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[5]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[6]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.0 [get_ports {wdata[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports spi_cs]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.002 [get_ports {data_to_mosi[7]}]
set_ideal_net [get_nets {wdata[7]}]
set_ideal_net [get_nets {wdata[6]}]
set_ideal_net [get_nets {wdata[5]}]
set_ideal_net [get_nets {wdata[4]}]
set_ideal_net [get_nets {wdata[3]}]
set_ideal_net [get_nets {wdata[2]}]
set_ideal_net [get_nets {wdata[1]}]
set_ideal_net [get_nets {wdata[0]}]
set_ideal_net [get_nets clk]
set_ideal_net [get_nets rst]
set_ideal_net [get_nets data_av]
set_ideal_net [get_nets control_clk]
