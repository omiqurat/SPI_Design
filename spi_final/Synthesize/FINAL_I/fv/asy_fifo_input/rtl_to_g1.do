...
usage -auto
set log file fv/asy_fifo_input/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/asy_fifo_input/rtl_to_g1.ovf
...
elaborate design -golden -root asy_fifo_input

read design -verilog -revised -lastmod -noelab \
	-unzip fv/asy_fifo_input/g1.v.gz

elaborate design -revised -root asy_fifo_input
