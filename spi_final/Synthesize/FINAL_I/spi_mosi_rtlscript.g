...
define_clock -name spi_clk -period 50000 [list "spi_clk"]
external_delay -clock spi_clk -input 0  /designs/*/ports_in/*
external_delay -clock spi_clk -output 2 /designs/*/ports_out/*
...
# spi_mosi (control_clk,spi_mosi_out,spi_cs,spi_clk,n_reset,spi_mosi_in);


dc::set_ideal_net spi_cs
dc::set_ideal_net n_reset
dc::set_ideal_net spi_mosi_in[0]
dc::set_ideal_net spi_mosi_in[1]
dc::set_ideal_net spi_mosi_in[2]
dc::set_ideal_net spi_mosi_in[3]
dc::set_ideal_net spi_mosi_in[4]
dc::set_ideal_net spi_mosi_in[5]
dc::set_ideal_net spi_mosi_in[6]
dc::set_ideal_net spi_mosi_in[7]

dc::set_ideal_net spi_clk
...
write_sdf -nonegchecks > spi_mosi_sdf.sdf

# rc -f spi_mosi_rtlscript.g 
